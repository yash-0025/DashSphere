        ...
        <div className="flex-1 flex flex-col min-w-0 lg:ml-[288px] transform-gpu">
          ...
          <main className="flex-1 px-4 sm:px-6 md:px-8 py-6">
            <div className="max-w-7xl mx-auto w-full space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="group bg-gradient-to-br from-electric/5 to-electric-light/5 backdrop-blur-sm rounded-2xl shadow-[0_0_12px_rgba(0,255,255,0.15)] p-6 ring-1 ring-electric/30 hover:ring-electric/60 transition-all duration-150">
                  <h3 className="text-xl font-semibold mb-4 text-electric-light">Sales Performance</h3>
                  <div className="w-full h-[300px]">
                    <SalesPerformanceChart />
                  </div>
                ...
                <div className="group bg-gradient-to-br from-neon/5 to-neon-light/5 backdrop-blur-sm rounded-2xl shadow-[0_0_12px_rgba(173,255,47,0.15)] p-6 ring-1 ring-neon/30 hover:ring-neon/60 transition-all duration-150">
                  <h3 className="text-xl font-semibold mb-4 text-neon-light">Product Sales</h3>
                  <div className="w-full h-[300px]">
                    <ProductSalesChart />
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="group bg-gradient-to-br from-lava/5 to-lava-light/5 backdrop-blur-sm rounded-2xl shadow-[0_0_12px_rgba(255,69,58,0.15)] p-6 ring-1 ring-lava/30 hover:ring-lava/60 transition-all duration-150">
                  <h3 className="text-xl font-semibold mb-4 text-lava-light">Market Share</h3>
                  <div className="w-full h-[300px]">
                    <MarketShareChart />
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-hyper/5 backdrop-blur-sm rounded-2xl shadow-xl p-6 ring-1 ring-electric/20">
                  <ActivityFeed />
                </div>
                <div className="bg-gradient-to-br from-electric/5 via-neon/5 to-lava/5 backdrop-blur-sm rounded-2xl shadow-xl p-6 ring-1 ring-neon/20">
                  <FormExample />
                </div>
              </div>
